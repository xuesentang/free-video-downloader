...
万能视频解析器是一个功能强大的在线视频解析工具，支持从 1800+ 视频平台解析视频，并提供 AI 智能总结、字幕提取、思维导图生成等高级功能。
...
├── backend/                    # FastAPI 后端
│   ├── main.py                 # 应用入口 + 路由
│   ├── downloader.py           # yt-dlp 封装（视频解析/解析）
│   ├── douyin.py               # 抖音专用解析模块
