<template>
  <section id="features" class="py-16 sm:py-20 bg-bg-main relative" aria-labelledby="features-heading">
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="text-center mb-12">
        <h2 id="features-heading" class="text-2xl sm:text-3xl font-bold text-text-primary mb-3">
          为什么选择 <span class="gradient-text">VideoParser</span> 视频解析器
        </h2>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5">
        <article
          ...
          :key="feature.title"
          class="group glass-card rounded-2xl p-6 border border-border hover:neon-border transition-all cursor-pointer"
        >
...
const features = [
  {
    ...
    bgClass: 'bg-primary/10 feature-icon-glow',
  },
  {
    icon: '⚡',
    title: '极速解析下载',
